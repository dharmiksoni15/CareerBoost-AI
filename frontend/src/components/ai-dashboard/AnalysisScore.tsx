...
export default function AnalysisScore({score=0}){
  return (
    <motion.div initial={{opacity:0, y:8}} animate={{opacity:1, y:0}} className="bg-white/5 rounded-2xl p-6 flex items-center gap-6">
      <div className="flex items-center gap-4">
        <motion.div initial={{scale:0.8}} animate={{scale:1}} className={`w-32 h-32 bg-gradient-to-br from-black/40 to-white/5 rounded-full flex items-center justify-center ${getColor(score)}`}>
